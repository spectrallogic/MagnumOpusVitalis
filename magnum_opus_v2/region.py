...
This is the abstraction that lets the same dynamics be applied, in
different manners, by every area of the mind.
...
class PerturbationRegion(Region):
    ...
    flow tick. Available for substrate-only verification — confirm the
    bus responds to inputs and that attractor dynamics pull it back.
    """

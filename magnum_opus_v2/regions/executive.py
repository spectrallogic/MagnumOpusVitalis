...
Design rule: the decision to speak arises from the latent space
itself — a geometric pressure, never a prompt. Awareness of time
...
class Executive(Region):
    ...
    def __init__(
        ...
        # Wall-time bookkeeping. Honest note: freshness and the speech
        # cooldown ARE wall-clock decays that gate decisions — subjective
        # time's magnitude is state-derived, these gates are not.
        ...
        # Set on each step so _effective_threshold can apply reward modulation.
